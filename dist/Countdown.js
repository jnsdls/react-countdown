  ...
  _createClass(Countdown, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var date = nextProps.date,
          ...
          restartOnDateChangeAfterComplete = nextProps.restartOnDateChangeAfterComplete;


      var timeDifference = getTimeDifference(date, {
        now: now,
        precision: precision,
        controlled: controlled
      });
...
Countdown.propTypes = {
  ...
  restartOnDateChangeAfterComplete: _propTypes2.default.bool
};
